...
namespace Gst {
	...
	public class Pad : Gst.Object {
		...
		public bool set_active (bool active);
		[CCode (cname = "gst_pad_set_chain_function")]
		...
		[CCode (cname = "gst_pad_set_event_function")]
	...
	[CCode (cheader_filename = "gst/gst.h", cname = "GST_PLUGIN_DEFINE")]
	public static void plugin_define (int major, int minor, string name, string description, Gst.PluginInitFunc plugin_init, string version, string license, string package, string origin);
}
